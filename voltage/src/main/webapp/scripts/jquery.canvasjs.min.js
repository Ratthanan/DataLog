...
(function () {
        ...
        ca = {
            ...
            return function (k, q, h) {
                ...
                var t = k[h + "Date"](), y = k[h + "Day"](),
                    s = k[h + "Month"](), z = k[h + "FullYear"](), w = k[h + "Hours"](), u = k[h + "Minutes"](),
                    W = k[h + "Seconds"](), x = k[h + "Milliseconds"](), v = r ? 0 : k.getTimezoneOffset();
            ...
            c = String(c);
            var g = 1, k = b = "", q = -1, h = [], n = [], m = 0, l = 0, p = 0, r = !1, t = 0,
                k = c.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            c = null;
    ...
    v.prototype._updateOptions =
        function () {
            ...
            if ("undefined" === typeof qa.Chart.creditHref) this.creditText = "CanvasJS.com"; else var b = this.updateOption("creditText"),
    ...
    v.prototype._plotAreaMouseUp = function (a, c) {
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            var b = c -
                this.dragStartPoint.y, d = a - this.dragStartPoint.x, e = 0 <= this.zoomType.indexOf("x"),
                f = 0 <= this.zoomType.indexOf("y"), g = !1;
            ...
            if (this.panEnabled || this.zoomEnabled) {
                ...
                g && (this._ignoreNextEvent =
                    !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.render(), this._dispatchRangeEvent("rangeChanged", "zoom"), g && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (la(this._zoomButton, this._resetButton), U(this, this._zoomButton, "pan"), U(this, this._resetButton, "reset")))
            }
        }
        this.isDrag = !1
    };
    v.prototype._plotAreaMouseMove = function (a, c) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!e || 2 < Math.abs(b) || !f || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled)) if (this.panEnabled) e = {
                ...
                var d = e ? this.dragStartPoint.x : this.plotArea.x1, g = f ? this.dragStartPoint.y : this.plotArea.y1,
    ...
    v.prototype.renderIndexLabels = function (a) {
        ...
        for (var c = this.plotArea, b = 0, d = 0, e = 0, f = 0, g = b = f = d = e = 0, k = 0, q = 0; q < this._indexLabels.length; q++) {
            var h = this._indexLabels[q], n = h.chartType.toLowerCase(), m, l, p = R("indexLabelFontColor",
                h.dataPoint, h.dataSeries), g = R("indexLabelFontSize", h.dataPoint, h.dataSeries),
            ...
            var f = R("indexLabelBackgroundColor", h.dataPoint, h.dataSeries),
                ...
                s = {percent: null, total: null}, z = null;
            ...
            if (null !== w && "" !== w) {
                var s = R("indexLabelPlacement", h.dataPoint, h.dataSeries),
                    z = R("indexLabelOrientation", h.dataPoint, h.dataSeries), u = h.direction, W = h.dataSeries.axisX,
                    A = h.dataSeries.axisY, v = !1, p = new O(a, {
                        x: 0,
                        y: 0,
    ...
    v.prototype.renderColumn = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = 0, f, g, k,
                q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
    ...
    v.prototype.renderStackedColumn100 = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = [], f = [], g = 0, k,
                q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
                g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1,
    ...
    v.prototype.renderArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                d.fillStyle = g;
                var g = [], m = !0, l = 0, p, r, t,
                    y = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0,
                    s, z = null;
                if (0 < n.length) {
                    ...
                    var A = "solid";
                    if (b.setLineDash) {
                        var H = D(h.nullDataLineDashType, h.lineThickness), A = h.lineDashType,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < n.length) {
                    ...
                    var v = "solid";
                    if (b.setLineDash) {
                        var A = D(h.nullDataLineDashType, h.lineThickness), v = h.lineDashType,
    ...
    v.prototype.renderStackedArea = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, e = [], f = this.plotArea, g = [], k = [], q = [], h = 0, n, m, l,
                p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) <<
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < q.length) {
                    ...
                    var v = "solid";
                    if (b.setLineDash) {
                        var A = D(s.nullDataLineDashType, s.lineThickness), v = s.lineDashType,
    ...
    v.prototype.renderStackedArea100 = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, e = this.plotArea, f = [], g = [], k = [], q = [], h = 0, n, m, l,
                p = a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
            ...
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < q.length) {
                    ...
                    var H = "solid";
                    if (b.setLineDash) {
                        var K = D(w.nullDataLineDashType, w.lineThickness), H = w.lineDashType,
    ...
    v.prototype.renderScatter = function (a) {
        ...
        if (!(0 >= b)) {
            var d = this.plotArea,
                e = 0, f, g, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width << 0,
                e = a.axisX.dataInfo.minDiff,
                b = 0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(e) / b) << 0;
            c.save();
            u && this._eventManager.ghostCtx.save();
    ...
    v.prototype.renderCandlestick =
        function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var d = null, d = this.plotArea, e = 0, f, g, k, q, h, n,
                    e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < t.length) for (var y = 5 < m && r.bevelEnabled ? !0 : !1, e = 0; e < t.length; e++) if (t[e].getTime ? n = t[e].x.getTime() : n = t[e].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax) && null !== t[e].y && t[e].y.length && "number" === typeof t[e].y[0] && "number" === typeof t[e].y[1] && "number" === typeof t[e].y[2] && "number" === typeof t[e].y[3]) {
                        ...
                        var s = f - m / 2 << 0, z = s + m << 0, d = t[e].color ? t[e].color : r._colorSet[0],
                            w = Math.round(Math.max(1, 0.15 * m)), x = 0 === w % 2 ? 0 : 0.5, v = r.dataPointIds[e];
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < h.length) {
                    ...
                    var x = "solid";
                    if (b.setLineDash) {
                        var v = D(q.nullDataLineDashType, q.lineThickness), x = q.lineDashType,
    ...
    v.prototype.renderPie = function (a) {
        function c() {
            if (h &&
                ...
                for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                    var f = n[e], g = h.dataPointIds[e],
                        k = {id: g, objectType: "dataPoint", dataPointIndex: e, dataSeriesIndex: 0};
                    p.push(k);
        ...
        var q = this;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var h = this.data[a.dataSeriesIndexes[0]], n = h.dataPoints, m = 10, l = this.plotArea, p = [], r = 2, t,
                y = 1.3, s = 20 / 180 * Math.PI, u = 6, w = {x: (l.x2 + l.x1) / 2, y: (l.y2 + l.y1) / 2}, v = 0;
            a = !1;
    ...
    ga.prototype.render = function () {
        if (this.text) {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, c = a.layoutManager.getFreeSpace(),
                b = c.x1, d = c.y1, e = 0, f = 0,
                g = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, k, q;
        ...
        for (var n = 0; n < this.dataSeries.length; n++) {
            ...
            if ("pie" !== m.type && "doughnut" !== m.type && "funnel" !== m.type) {
                var l = m.legendMarkerType ? m.legendMarkerType : "line" !== m.type && "stepLine" !== m.type &&
                    ...
                    p = this.chart.replaceKeywordsWithValue(p, m.dataPoints[0], m, n), l = {
                        markerType: l,
                        markerColor: r,
                        text: p,
                        textBlock: null,
                ...
                var w = m.dataPoints[v], l = w.legendMarkerType ? w.legendMarkerType :
                    ...
                    t = 0.75 * this.lineHeight, u = w.legendMarkerBorderColor ? w.legendMarkerBorderColor :
                    ...
                    p = this.chart.replaceKeywordsWithValue(p, w, m, v), l = {
                        markerType: l,
                        markerColor: r,
                        text: p,
                        textBlock: null,
    ...
    Y.prototype.getDataPointAtX = function (a, c) {
        ...
        var b = {dataPoint: null, distance: Infinity, index: NaN}, d = null, e = 0, f = 0, g = 1, k = Infinity, q = 0,
            h = 0, n = 0;
            ...
            if (0 <= f && f < this.dataPoints.length) {
                ...
                if (l) {
                    switch (this.type) {
                        ...
                        case "scatter":
                            var t =
                                R("markerSize", p, this) || 4, u = b ? 20 : t,
    ...
    F.prototype.createLabelsAndCalculateWidth = function () {
        ...
        if ("left" === this._position || "right" === this._position) {
            ...
            for (c = 0; c < this._labels.length; c++) {
                var b =
                        this._labels[c].textBlock, d = b.measureText(), e = 0,
    ...
    V.prototype._updateToolTip = function (a, c) {
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared &&
                ...
                if (g = this.chart.getDataPointAtXY(a, c, !0)) this.currentDataPointIndex = g.dataPointIndex, this.currentSeriesIndex = g.dataSeries.index; else if (u) if (g = Ea(a, c, this.chart._eventManager.ghostCtx), 0 < g && "undefined" !==
    ...
    v.prototype.replaceKeywordsWithValue = function (a, c, b, d, e) {
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            var g = "#percent", k = "#total", q = this.getPercentAndTotal(b, c), k = isNaN(q.total) ? k : q.total,
